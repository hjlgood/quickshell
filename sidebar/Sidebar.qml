            ...
            ColumnLayout {
                ...
                ColumnLayout {
                    ...
                    Process {
                        ...
                        stdout: StdioCollector {
                            onStreamFinished: {
                                ...
                                if (!isNaN(val))
                                    systemInfo.cpuUsage = val / 100.0; // Normalize to 0.0-1.0
                            }
                        }
                    }
                    ...
                    Process {
                        ...
                        stdout: StdioCollector {
                            onStreamFinished: {
                                var val = parseFloat((this.text || "0").trim());
                                if (!isNaN(val))
                                    systemInfo.diskUsage = val / 100.0;
                            }
                        }
                    }
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: Math.round(systemInfo.ramUsage * 100) + "%"
                            color: Colors.text
                            font.family: "RedHatDisplay"
                            font.pixelSize: 12
                            Layout.preferredWidth: 30
                    ...
                    RowLayout {
                        ...
                        Text {
                            text: Math.round(systemInfo.diskUsage * 100) + "%"
                            color: Colors.text
                            font.family: "RedHatDisplay"
                            font.pixelSize: 12
                            Layout.preferredWidth: 30
